...
class CRM_Banking_PluginImpl_Matcher_CreateMultipleContributions extends CRM_Banking_PluginModel_Matcher {
  ...
  public function visualize_match(CRM_Banking_Matcher_Suggestion $suggestion, $btx) {
    ...
    $smarty_vars['notes'] = $suggestion->getParameter('notes');
    ...
    $contributions = $suggestion->getParameter('contributions');
    ...
    $skipped_contributions = $suggestion->getParameter('skipped_contributions');
  ...
  public function visualize_execution_info(CRM_Banking_Matcher_Suggestion $suggestion, $btx) {
    ...
    $smarty_vars = [];
    $smarty_vars['contribution_ids'] = $suggestion->getParameter('contribution_ids');
