...
abstract class CRM_Banking_PluginModel_Exporter extends CRM_Banking_PluginModel_IOPlugin {
   ...
   * @return bool
   */
  abstract public function does_export_files();
   ...
   * @return bool
   */
  abstract public function does_export_stream();
   ...
   */
  abstract public function export_file($txbatch2ids, $parameters);
   ...
   */
  abstract public function export_stream($txbatch2ids, $parameters);
   ...
   *
   * @param array $params not yet specified
   *
   * @return string a file path to an existing file
   */
  ...
  public function getBatchData($tx_batch_id) {
    ...
    $txbatch = civicrm_api3('BankingTransactionBatch', 'getsingle', ['id' => $tx_batch_id]);
   ...
   *
   * @return array an array containing all values, keys prefixed with 'tx_'
   *
