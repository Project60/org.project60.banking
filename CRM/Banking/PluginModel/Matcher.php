...
abstract class CRM_Banking_PluginModel_Matcher extends CRM_Banking_PluginModel_BtxBase {
   ...
   *
   * @param \CRM_Banking_Matcher_Suggestion $suggestion Suggestion as previously generated by this plugin instance
   * @param \CRM_Banking_BAO_BankTransaction $btx the bank transaction the suggestion refers to
   * @return bool|"re-run" the execution result:
   *   TRUE if successful
   *   FALSE if not successful
   *   're-run' if the analysis should be re-run (UI only)
   */
  public function execute($suggestion, $btx) {
    $suggestion->setExecuted();
    $btx->saveSuggestions();
    return TRUE;
  }
