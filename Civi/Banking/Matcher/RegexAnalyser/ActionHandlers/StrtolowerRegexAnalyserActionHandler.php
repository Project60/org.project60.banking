 ...
 * String to lowercase.
 */
final class StrtolowerRegexAnalyserActionHandler implements RegexAnalyserActionHandlerInterface {

  public const NAME = 'strtolower';
  ...
  public function execute(\stdClass $action, RegexAnalyserMatchContext $matchContext): void {
    ...
    if (!is_string($value)) {
      ...
      $matchContext->setParsedValue($action->to, strtolower($value));
    }
  }
