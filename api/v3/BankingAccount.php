  ...
  $existing_ba_id = CRM_Core_DAO::singleValueQuery('
    ...
    WHERE ba.contact_id = %1
      ...
      LIMIT 1', [
        ...
        2 => [$params['reference'], 'String'],
        3 => [$reference_type_id, 'Integer'],
      ]);
  if ($existing_ba_id) {
    // this account exists!
    return civicrm_api3('BankingAccount', 'getsingle', ['id' => $existing_ba_id]);
    ...
    foreach (['description', 'name', 'country'] as $attribute) {
    ...
    // and then create!
    $new_bank_account = civicrm_api3('BankingAccount', 'create', [
    ...
    return civicrm_api3('BankingAccount', 'getsingle', ['id' => $new_bank_account['id']]);
  }
}
