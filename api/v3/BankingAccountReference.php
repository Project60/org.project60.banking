 ...
 *   'reference' => reference to be checked
 *   'reference_type' => id (not value) of the reference type OptionValue
 *   'reference_type_name' => name of reference type, e.g. NBAN_DE
 *
 * @return array
 *   'is_valid'   0/1: is the given reference valid? 0 could also mean "not checked", see below
...
function civicrm_api3_banking_account_reference_check($params) {
  ...
  if (!empty($params['reference_type'])) {
    ...
    $params['reference_type_name'] = civicrm_api3('OptionValue', 'getvalue', ['id' => ((int) $params['reference_type']), 'return' => 'name']);
  }
