...
abstract class CRM_Banking_PluginModel_Importer extends CRM_Banking_PluginModel_IOPlugin {
  ...
  protected $_current_transaction_batch_isnew = FALSE;
  protected $_current_transaction_batch_sum = 0.0;
  ...
  function openTransactionBatch($batch_id=0) {
    if ($this->_current_transaction_batch==NULL) {
      ...
      if ($batch_id) {
        ...
        $this->_current_transaction_batch_isnew = FALSE;
        $this->_current_transaction_batch_sum = ($this->_current_transaction_batch->ending_balance - $this->_current_transaction_batch->starting_balance);
      } else {
        ...
        $this->_current_transaction_batch->reference = microtime();
        $this->_current_transaction_batch->sequence = 0;
        $this->_current_transaction_batch->tx_count = 0;
        //       /\ 

        $this->_current_transaction_batch->save();
        $this->_current_transaction_batch_isnew = TRUE;
        $this->_current_transaction_batch_sum = 0;
      }
    } else {
    ...
    if ($this->_current_transaction_batch!=NULL) {
      if ($store) {
        ...
        if ($this->_current_transaction_batch->ending_balance) {
          ...
          $deviation = $sum_in_bao - $this->_current_transaction_batch_sum;
          $correct_value = $this->_current_transaction_batch->starting_balance + $this->_current_transaction_batch_sum;
          ...
          $this->_current_transaction_batch->ending_balance = $this->_current_transaction_batch->starting_balance + $this->_current_transaction_batch_sum;
        }

        $this->_current_transaction_batch->save();

      } else if ($this->_current_transaction_batch_isnew) {
