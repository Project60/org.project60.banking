...
CREATE TABLE IF NOT EXISTS `civicrm_bank_account` (
     ...
     `is_primary`    TINYINT      NOT NULL  COMMENT 'defines a BA as the default',
     `is_active`     TINYINT      DEFAULT 1 COMMENT 'if disabled, a BA should not be used any more',
    PRIMARY KEY ( `id` ),
...
CREATE TABLE IF NOT EXISTS `civicrm_bank_tx` (
     ...
     `type_id`        int unsigned  NOT NULL COMMENT 'ID of an option value',
     `status_id`      int unsigned  NOT NULL COMMENT 'ID of an option value',
