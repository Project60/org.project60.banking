...
<p>
  {if $cancellation_mode}
    {ts 1=$contribution_link 2=$contribution_id}This SEPA transaction cancelled <a href="%1">contribution #%2</a>.{/ts}
    {if $cancel_reason}
    ...
    {/if}
  {else}
    {ts 1=$contribution_link 2=$contribution_id}This SEPA transaction was reconciled with <a href="%1">contribution #%2</a>.{/ts}
  {/if}
</p>