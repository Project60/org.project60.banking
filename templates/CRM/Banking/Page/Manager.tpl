...
<div id="help">
	...
	{ts domain='org.project60.banking' 1=$settings_link}You might also want to have a look at the <a href="%1" target="_blank">CiviBanking <strong>SETTINGS</strong></a>{/ts}
</div>
<br/>
