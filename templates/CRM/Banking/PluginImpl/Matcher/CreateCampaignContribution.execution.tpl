...
<p>
  {ts 1=$contribution_link 2=$contribution_id domain='org.project60.banking'}This transaction was associated with the new <a href="%1">campaign contribution #%2</a>.{/ts}
</p>
