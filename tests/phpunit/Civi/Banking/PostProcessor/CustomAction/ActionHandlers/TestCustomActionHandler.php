...
final class TestCustomActionHandler implements CustomActionHandlerInterface {
  ...
  /**
   * @var \Civi\Banking\PostProcessor\CustomAction\CustomActionHandlerInterface<object>
   */
  ...
  public static function clearTestCalls(): void {
    self::$testCalls = [];
  }
  ...
  /**
   * @param \Civi\Banking\PostProcessor\CustomAction\CustomActionHandlerInterface<object> $decorated
   */
